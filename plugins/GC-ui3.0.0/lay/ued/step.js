        ...
        line: function () {
            ...
            (function (factory) {
                ...
                $.fn.step = function (options) {
                    ...
                    this.find(".step-header li").css({"width": 100 / size + "%"});
                    this.find(".step-header").show();
                    this.find(".step-bar-active").animate({"width": barWidth + "%"}, opts.speed, function () {
                    });
                ...
                $.fn.step.defaults = {animate: true, speed: 500, initStep: 1, scrollTop: true}
            }))
        }
    };
    exports("step", obj)
